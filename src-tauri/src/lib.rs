...
pub fn run() {
  let specta = tauri_specta::Builder::new()
    .commands(collect_commands![
      ...
      view::ctrl::command::get_ignore_cursor_events,
      view::ctrl::command::get_pin,
      view::ctrl::command::get_transparent,
      view::ctrl::command::set_ignore_cursor_events,
      view::ctrl::command::set_pin,
      view::ctrl::command::set_transparent,
      view::ctrl::command::toggle_ignore_cursor_events,
